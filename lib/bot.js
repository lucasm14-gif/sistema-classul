...
const MAX_PHOTOS_PER_REPLY = 5;

// Catálogo de fotos que o bot pode enviar. As imagens ficam em web/public/bot-fotos
// (servidas publicamente pela Vercel). O modelo pede as fotos de um produto com [[FOTO:chave]]
// e o bot envia TODAS as fotos daquele produto.
const MEDIA = {
  placa_homenagem: {
    label: 'Placa de homenagem',
    files: [
      'placa-homenagem-1.jpg',
      'placa-homenagem-2.jpg',
      'placa-homenagem-3.jpg',
      'placa-homenagem-4.jpg',
      'placa-homenagem-5.jpg'
    ]
  },
